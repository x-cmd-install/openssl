...
合计: **996,342** 行代码（覆盖前 5 种语言、共 **2806** 个文件）。
...
- **Star**: 30,771 · **Fork**: 11,454 · **开放 issue**: 11,717 · **贡献者**: 1,232

## 累计统计

- **发布数**: 316 · **已合并 PR**: 149 · **开放 PR**: 581 · **已关闭 issue**: 10718 · **开放 issue**: 999 · **提交数**: 41057
...
在 [repology.org](https://repology.org/project/openssl) 上共有 **987** 个发行版报告此项目。**18** 个 ✅ 已是最新上游版本，**655** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260911.yml` · 2026-09-11T05:21:09Z._
