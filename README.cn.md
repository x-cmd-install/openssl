...
[![x-cmd/install — openssl Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/openssl.svg?lang=zh)](https://x-cmd.com/install/openssl)
...
合计: **1,002,207** 行代码（覆盖前 5 种语言、共 **2815** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| C | 644,531 | 100,799 | 98,135 | 1688 |
| Perl | 238,870 | 27,221 | 32,163 | 348 |
| CHeader | 57,873 | 22,111 | 8,924 | 485 |
...
- **最新版本**: `openssl-4.1.0-alpha1` (2026-08-25)
- **最近提交**: 2026-09-22
- **Release 含资产**: 4 个

## 流行度

- **Star**: 30,825 · **Fork**: 11,481 · **开放 issue**: 11,739 · **贡献者**: 1,234

## 累计统计

- **发布数**: 316 · **已合并 PR**: 149 · **开放 PR**: 583 · **已关闭 issue**: 10746 · **开放 issue**: 993 · **提交数**: 41188

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-24 | 6 | 1 | 201 | 26 | 52 | 164 |
| last60d | 2026-07-25 | 6 | 1 | 283 | 73 | 113 | 354 |
| 90d | 2026-06-25 | 6 | 1 | 313 | 105 | 137 | 607 |
| last180d | 2026-03-27 | 17 | 1 | 424 | 254 | 247 | 1310 |
| 360d | 2025-09-28 | 30 | 4 | 511 | 516 | 388 | 2526 |
| last720d | 2024-10-03 | 49 | 13 | 552 | 1240 | 548 | 5304 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/openssl.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T05:28:25Z._
